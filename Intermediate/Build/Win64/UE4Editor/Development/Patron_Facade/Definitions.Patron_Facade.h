...
#define UE_PROJECT_NAME Patron_Facade
#define UE_TARGET_NAME Patron_FacadeEditor
#define UE_MODULE_NAME "Patron_Facade"
...
#define PATRON_FACADE_API DLLEXPORT
